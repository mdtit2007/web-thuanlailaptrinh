...
const GithubIcon = () => (
  ...
  >
    <path
      ...
      .108-.775.418-1.305.762-1.605-2.665-.305-5.466-1.332-5.466-5.931
      0-1.31.467-2.381 1.235-3.221-.123-.303-.535-1.527.117-3.176 0 0
      1.008-.322 3.301 1.23a11.5 11.5 0 013.003-.404c1.018.005 2.043.138 3.003.404
      2.292-1.552 3.3-1.23 3.3-1.23.653 1.649.241 2.873.118 3.176
      .77.84 1.233 1.911 1.233 3.221 0 4.61-2.803 5.624-5.475 5.921
      .43.372.823 1.102.823 2.222 0 1.606-.014 2.896-.014 3.286
      0 .319.218.694.825.576C20.565 22.092 24 17.592 24 12.297
   ...
   <section className="min-h-screen flex items-center justify-center  bg-gray-50 dark:bg-gray-900">
      ...
      <div className="relative w-full max-w-sm p-6 space-y-6 bg-white dark:bg-black rounded-lg border border-zinc-200 dark:border-zinc-800 shadow-lg dark:shadow-zinc-900/50">
        ...
        <div className="text-center space-y-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-white">Chào mừng </h1>
            <p className="text-sm text-zinc-600 dark:text-zinc-400 mt-1">Nhập thông tin đăng nhập của bạn để đăng nhập</p>
          </div>
        </div>

        {/* Social login buttons - More compact shadcn style */}
        <div className="grid grid-cols-2 gap-2">
          {[ { icon: <GoogleIcon /> }, { icon: <GithubIcon /> }].map((item, index) => (
            <button
              key={index}
        ...
        <div className="text-center space-y-2">
          <p className="text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <Link href="/signup" className="font-medium text-zinc-900 dark:text-zinc-50 underline underline-offset-4 hover:text-zinc-700 dark:hover:text-zinc-300 transition-colors">
                 Đăng ký
            </Link>
          </p>
          <Link href="/forgotpassword" className="text-sm font-medium text-zinc-900 dark:text-zinc-50 underline underline-offset-4 hover:text-zinc-700 dark:hover:text-zinc-300 transition-colors">
           Quên mật khẩu?
          </Link>
        </div>
